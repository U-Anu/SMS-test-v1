...
class Currency(models.Model):
    ...
    branch = models.ForeignKey("sub_part.Branch",on_delete=models.CASCADE,related_name="Currency_branch",null=True, blank=True)
...
class Branch(models.Model):
    ...
    school = models.ForeignKey(
        ...
        related_name="branch_school",
        
    )
    staff_in_charge = models.ForeignKey(
        "sub_part.Addstaff",
        on_delete=models.CASCADE,
        related_name="staff_in_charge_branch",null=True, blank=True
    )
    admin_in_charge = models.ForeignKey(
        "sub_part.Addstaff",
        on_delete=models.CASCADE,
        related_name="admin_in_charge_branch",null=True, blank=True
    )
    reference_id =  models.CharField(max_length=100,null=True, blank=True)
...
class User(AbstractUser):
    ...
    buyer_id = models.CharField(max_length=300,blank=True, null=True)
...
class StudentGuardianDetails(models.Model): 
    ...
    phone=models.CharField(max_length=513,blank=True, null=True) #!
...
class MeetingLinkMaster(models.Model):
    ...
    type_of_application = models.CharField(max_length=100,choices=Application)
...
class Question(models.Model):
    ...
    def save(self, *args, **kwargs):
        # Set default mark from the part if not explicitly provided
...
class EnrollmentAssign(models.Model):
    ...
    section = models.ManyToManyField(Section)  
    branch = models.ForeignKey(Branch, on_delete=models.CASCADE, null=True, blank=True)   
    created_by = models.ForeignKey(User, on_delete=models.CASCADE, blank=True, null=True, related_name="craeted_by_EnrollmentAssign")
    created_at = models.DateTimeField(auto_now_add=True, blank=True, null=True) 
...
class Vendor(models.Model):
    ...
    address = models.TextField(blank=True, null=True)
    created_by = models.ForeignKey(
        User, on_delete=models.CASCADE, blank=True, null=True, related_name="created_by_vendor"
    )
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    branch = models.ForeignKey(Branch, on_delete=models.CASCADE, null=True, blank=True)
...
class ExpenseCategory(models.Model):
    ...
    description = models.TextField(blank=True, null=True)
    created_by = models.ForeignKey(
        User, on_delete=models.CASCADE, blank=True, null=True, related_name="craeted_by_ExpenseCategory"
    )
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    branch = models.ForeignKey(Branch, on_delete=models.CASCADE, null=True, blank=True)            
...
class Expense(models.Model):
    ...
    status = models.CharField(max_length=100, choices=Status,default="Pending")  # Default set to 'Pending'
    ...
    created_by = models.ForeignKey(
        User, on_delete=models.CASCADE, blank=True, null=True, related_name="craeted_by_Expense"
    )
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    branch = models.ForeignKey(Branch, on_delete=models.CASCADE, null=True, blank=True)            
...
class Invoice(models.Model):
    ...
    payment_date = models.DateField(null=True, blank=True)
    created_by = models.ForeignKey(
        User, on_delete=models.CASCADE, blank=True, null=True, related_name="craeted_by_Invoice"
    )
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    branch = models.ForeignKey(Branch, on_delete=models.CASCADE, null=True, blank=True)            
...
class Employee(models.Model):
    ...
    user_role_id = models.IntegerField(default=1)
...
class UserSubscription(models.Model):
    company = models.ForeignKey(SchoolRegistration, on_delete=models.CASCADE)
    start_date = models.DateField()
    end_date = models.DateField()
    ...
    def __str__(self):
        return f"{self.company.school_name} Subscription"
...
class Feedback(models.Model):
    ...
    def __str__(self):
        return f"Feedback for {self.user.username} - {self.feedback}"
