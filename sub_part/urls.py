...
# ==========
    ...
    path("admission_enquiry_edit/<pk>",views.admission_enquiry_edit,name="admission_enquiry_edit"),
    path("admission_enquiry_view/<pk>",views.admission_enquiry_view,name="admission_enquiry_view"),
    path("admission_enquiry_delete/<pk>",views.admission_enquiry_delete,name="admission_enquiry_delete"),
    ...
    path("visitor_book_delete/<pk>",views.visitor_book_delete,name="visitor_book_delete"),
    path("phone_call_log", views.phone_call_log, name="phone_call_log"),
    path("phone_call_log_edit/<pk>",views.phone_call_log_edit,name="phone_call_log_edit"),
    path("phone_call_log_view/<pk>",views.phone_call_log_view,name="phone_call_log_view"),
    path("phone_call_log_delete/<pk>",views.phone_call_log_delete,name="phone_call_log_delete"),
    path("postal_dispatch", views.postal_dispatch, name="postal_dispatch"),
    path("postal_dispatch_edit/<pk>",views.postal_dispatch_edit,name="postal_dispatch_edit"),
    path("postal_dispatch_View/<pk>",views.postal_dispatch_view,name="postal_dispatch_view"),
    path("postal_dispatch_delete/<pk>",views.postal_dispatch_delete,name="postal_dispatch_delete"),
    path("postal_receive", views.postal_receive, name="postal_receive"),
    path("postal_receive_edit/<pk>",views.postal_receive_edit,name="postal_receive_edit"),
    path("postal_receive_view/<pk>",views.postal_receive_view,name="postal_receive_view"),
    path("postal_receive_delete/<pk>",views.postal_receive_delete,name="postal_receive_delete"),
    ...
    path("setup_front_office_purpose",views.setup_front_office_purpose,name="setup_front_office_purpose"),
    path("setup_front_office_purpose_edit/<pk>",views.setup_front_office_purpose_edit,name="setup_front_office_purpose_edit"),
    path("setup_front_office_purpose_delete/<pk>",views.setup_front_office_purpose_delete,name="setup_front_office_purpose_delete"),
    path("setup_front_office_complain_type",views.setup_front_office_complain_type,name="setup_front_office_complain_type"),
    path("setup_front_office_complain_type_edit/<pk>",views.setup_front_office_complain_type_edit,name="setup_front_office_complain_type_edit"),
    path("setup_front_office_complain_type_delete/<pk>",views.setup_front_office_complain_type_delete,name="setup_front_office_complain_type_delete"),
    path("setup_front_office_source",views.setup_front_office_source,name="setup_front_office_source"),
    path("setup_front_office_source_edit/<pk>",views.setup_front_office_source_edit,name="setup_front_office_source_edit"),
    path("setup_front_office_source_delete/<pk>",views.setup_front_office_source_delete,name="setup_front_office_source_delete"),
    path("setup_front_office_reference",views.setup_front_office_reference,name="setup_front_office_reference"),
    path("setup_front_office_reference_edit/<pk>",views.setup_front_office_reference_edit,name="setup_front_office_reference_edit"),
    path("setup_front_office_reference_delete/<pk>",views.setup_front_office_reference_delete,name="setup_front_office_reference_delete"),
    ...
    path("student_category_edit/<pk>",views.student_category_edit,name="student_category_edit"),
    path("student_category_view/<pk>",views.student_category_view,name="student_category_view"),
    path("student_category_delete/<pk>",views.student_category_delete,name="student_category_delete"),
    path("student_house", views.student_house, name="student_house"),
    path("student_house_edit/<pk>", views.student_house_edit, name="student_house_edit"),
    path("student_house_view/<pk>", views.student_house_view, name="student_house_view"),
    path("student_house_delete/<pk>",views.student_house_delete,name="student_house_delete"),
    path("disabled_reason", views.disabled_reason, name="disabled_reason"),
    path("disabled_reason_edit/<pk>",views.disabled_reason_edit,name="disabled_reason_edit"),
    path("disabled_reason_view/<pk>",views.disabled_reason_view,name="disabled_reason_view"),
    path("disabled_reason_delete/<pk>",views.disabled_reason_delete,name="disabled_reason_delete"),
    path("collect_fees", views.collect_fees, name="collect_fees"), 
    
    path("collect_fees_edit/<int:uniqueid>/<int:pk>", views.collect_fees_edit, name="collect_fees_edit"),
    ...
    path("collect_fees_detail/<pk>",views.collect_fees_detail,name="collect_fees_detail"),
    ...
    path("fees_master_assign/<pk>", views.fees_master_assign, name="fees_master_assign"),
    path("fees_master_assign_js",views.fees_master_assign_js,name="fees_master_assign_js"),
    ...
    path("fees_master_delete/<pk>", views.fees_master_delete, name="fees_master_delete"),
    ...
    path("fees_discount_edit/<pk>", views.fees_discount_edit, name="fees_discount_edit"),
    path("fees_discount_assign/<pk>",views.fees_discount_assign,name="fees_discount_assign"),
    path("fees_discount_delete/<pk>",views.fees_discount_delete,name="fees_discount_delete"),
    path("fees_discount_assign_js",views.fees_discount_assign_js,name="fees_discount_assign_js"),
    ...
    path("income_head_delete/<pk>", views.income_head_delete, name="income_head_delete"),
    # expense
    ...
    path("add_expense_delete/<pk>", views.add_expense_delete, name="add_expense_delete"),
    ...
    path("expense_head_delete/<pk>",views.expense_head_delete,name="expense_head_delete"),
    # Accounts
    # Asset Type
    ...
    path("add_gline_delete/<pk>", views.add_gline_delete, name="add_gline_delete"),
    # Account Type
    ...
    # Transaction Code
    path("add_transaction_code/", views.add_transaction_code, name="add_transaction_code"),
    path("view_transaction_code/",views.view_transaction_code,name="view_transaction_code"),
    # Charge Type
    ...
    # Transaction Type
    path("add_transaction_type/", views.add_transaction_type, name="add_transaction_type"),
    path("view_transaction_type/",views.view_transaction_type,name="view_transaction_type"),
    # Account Entry
    ...
    path("approve_leave_edit/<pk>", views.approve_leave_edit, name="approve_leave_edit"),
    path("approve_leave_view/<pk>", views.approve_leave_view, name="approve_leave_view"),
    path("approve_leave_delete/<pk>",views.approve_leave_delete,name="approve_leave_delete"),
    ...
    path("design_admit_card_edit/<pk>",views.design_admit_card_edit,name="design_admit_card_edit"),
    path("design_admit_card_view/<pk>",views.design_admit_card_view,name="design_admit_card_view"),
    path("design_admit_card_delete/<pk>",views.design_admit_card_delete,name="design_admit_card_delete"),
    ...
    path("design_marksheet_edit/<pk>",views.design_marksheet_edit,name="design_marksheet_edit"),
    path("design_marksheet_view/<pk>",views.design_marksheet_view,name="design_marksheet_view"),
    path("design_marksheet_delete/<pk>",views.design_marksheet_delete,name="design_marksheet_delete"),
    ...
    path("marks_grade_delete/<pk>", views.marks_grade_delete, name="marks_grade_delete"),
    #
    path("assign_subject", views.assign_subject, name="assign_subject"),
    path("assign_subject_edit/<pk>",views.assign_subject_edit,name="assign_subject_edit"),
    path("assign_subject_view/<pk>",views.assign_subject_view,name="assign_subject_view"),
    path("assign_subject_delete/<pk>",views.assign_subject_delete,name="assign_subject_delete"),
    # 68
    # Online Exam
    ...
    path("online_exam_delete/<pk>", views.online_exam_delete, name="online_exam_delete"),
    path("question_bank", views.question_bank, name="question_bank"),
    path("question_bank_edit/<pk>", views.question_bank_edit, name="question_bank_edit"),
    path("question_bank_view/<pk>", views.question_bank_view, name="question_bank_view"),
    path("question_bank_delete/<pk>",views.question_bank_delete,name="question_bank_delete"),
    ...
    path("lesson_bulk_delete/<sub>", views.lesson_bulk_delete, name="lesson_bulk_delete"),
    ...
    path("assign_class_teacher_edit/<pk>",views.assign_class_teacher_edit,name="assign_class_teacher_edit"),
    path("assign_class_teacher_view/<pk>",views.assign_class_teacher_view,name="assign_class_teacher_view"),
    path("assign_class_teacher_delete/<pk>",views.assign_class_teacher_delete,name="assign_class_teacher_delete"),
    #assign subject teacher
       path("assign_subject_teacher", views.assign_subject_teacher, name="assign_subject_teacher"),
    path("assign_subject_teacher_edit/<pk>",views.assign_subject_teacher_edit,name="assign_subject_teacher_edit"),
    path("assign_subject_teacher_view/<pk>",views.assign_subject_teacher_view,name="assign_subject_teacher_view"),
    path("assign_subject_teacher_delete/<pk>",views.assign_subject_teacher_delete,name="assign_subject_teacher_delete"),
    ...
    path("class_timetable_view", views.class_timetable_view, name="class_timetable_view"),
    ...
    path("subject_group_edit/<pk>", views.subject_group_edit, name="subject_group_edit"),
    path("subject_group_view/<pk>", views.subject_group_view, name="subject_group_view"),
    path("subject_group_delete/<pk>",views.subject_group_delete,name="subject_group_delete"),
    ...
    path("class_register_edit/<pk>",views.class_register_edit,name="class_register_edit"),
    path("class_register_view/<pk>",views.class_register_view,name="class_register_view"),
    path("class_register_delete/<pk>",views.class_register_delete,name="class_register_delete"),
    # educationlevel
    # school composition
    ...
    path("school_composition_edit/<pk>",views.school_composition_edit,name="school_composition_edit"),
    path("school_composition_view/<pk>",views.school_composition_view,name="school_composition_view"),
    path("school_composition_delete/<pk>",views.school_composition_delete,name="school_composition_delete"),
    # education level
    ...
    path("education_level_edit/<pk>",views.education_level_edit,name="education_level_edit"),
    path("education_level_view/<pk>",views.education_level_view,name="education_level_view"),
    path("education_level_delete/<pk>",views.education_level_delete,name="education_level_delete"),
    # Structure
    # curriculum
    ...
    path("school_year_delete/<pk>", views.school_year_delete, name="school_year_delete"),
    ...
    path("school_term_delete/<pk>", views.school_term_delete, name="school_term_delete"),
    # grading system
    ...
    path("grading_system_edit/<pk>",views.grading_system_edit,name="grading_system_edit"),
    ...
    path("approve_leave_request_edit/<pk>",views.approve_leave_request_edit,name="approve_leave_request_edit"),
    path("approve_leave_request_delete/<pk>",views.approve_leave_request_delete,name="approve_leave_request_delete"),
    ...
    path("add_leave_type_delete/<pk>",views.add_leave_type_delete,name="add_leave_type_delete"),
    path("add_leave_type_edit/<pk>",views.add_leave_type_edit,name="add_leave_type_edit"),
    path("teachers_rating_list", views.teachers_rating_list, name="teachers_rating_list"),
    path("teachers_rating_list", views.teachers_rating_list, name="teachers_rating_list"),
    ...
    path("upload_content_edit<pk>", views.upload_content_edit, name="upload_content_edit"),
    path("upload_content_delete<pk>",views.upload_content_delete,name="upload_content_delete"),
    path("assignment_list", views.assignment_list, name="assignment_list"),
    path("assignment_list_delete<pk>",views.assignment_list_delete,name="assignment_list_delete"),
    path("study_material", views.study_material, name="study_material"),
    path("study_material_delete<pk>",views.study_material_delete,name="study_material_delete"),
    ...
    path("libary_surrender_card/<pk>",views.libary_surrender_card,name="libary_surrender_card"),
    # Inventory
    ...
    path("add_item_category_view/<pk>",views.add_item_category_view,name="add_item_category_view"),
    path("add_item_category_delete/<pk>",views.add_item_category_delete,name="add_item_category_delete"),
    path("add_item_category_edit/<pk>",views.add_item_category_edit,name="add_item_category_edit"),
    ...
    path("item_supplier_view/<pk>", views.item_supplier_view, name="item_supplier_view"),
    path("item_supplier_delete/<pk>",views.item_supplier_delete,name="item_supplier_delete"),
    path("item_supplier_edit/<pk>", views.item_supplier_edit, name="item_supplier_edit"),
    ...
    path("assign_vehicle_view/<pk>",views.assign_vehicle_view,name="assign_vehicle_view"),
    path("assign_vehicle_delete/<pk>",views.assign_vehicle_delete,name="assign_vehicle_delete"),
    path("assign_vehicle_edit/<pk>",views.assign_vehicle_edit,name="assign_vehicle_edit"),
    path("hostel_room", views.hostel_room, name="hostel_room"),
    path("hostel_room_view/<pk>", views.hostel_room_view, name="hostel_room_view"),
    path("hostel_room_delete/<pk>", views.hostel_room_delete, name="hostel_room_delete"),
    ...
    path("student_certificate_view/<pk>",views.student_certificate_view,name="student_certificate_view"),
    path("student_certificate_delete/<pk>",views.student_certificate_delete,name="student_certificate_delete"),
    path("student_certificate_edit/<pk>",views.student_certificate_edit,name="student_certificate_edit"),
    path("student_id_card", views.student_id_card, name="student_id_card"),
    path("student_id_card_view/<pk>",views.student_id_card_view,name="student_id_card_view"),
    path("student_id_card_delete/<pk>",views.student_id_card_delete,name="student_id_card_delete"),
    path("student_id_card_edit/<pk>",views.student_id_card_edit,name="student_id_card_edit"),
    path("add_event", views.add_event, name="add_event"),
    path("media_manager", views.media_manager, name="media_manager"),
    path("media_manager_view/<pk>", views.media_manager_view, name="media_manager_view"),
    path("media_manager_delete/<pk>",views.media_manager_delete,name="media_manager_delete"),
    path("media_manager_edit/<pk>", views.media_manager_edit, name="media_manager_edit"),
    ...
    path("alumni_events_view/<pk>", views.alumni_events_view, name="alumni_events_view"),
    path("alumni_events_delete/<pk>",views.alumni_events_delete,name="alumni_events_delete"),
    path("alumni_events_edit/<pk>", views.alumni_events_edit, name="alumni_events_edit"),
    ...
    path("student_list_delete/<pk>",views.student_list_delete,name="student_list_delete"),
    path("student_information_report",views.student_information_report,name="student_information_report"),
    path("guardian_report", views.guardian_report, name="guardian_report"),
    path("student_history_report",views.student_history_report,name="student_history_report"),
    path("disable_enable", views.disable_enable, name="disable_enable"),
    path("add_issue_item", views.add_issue_item, name="add_issue_item"),
    #
    path("non_returnable_items/",views.non_returnable_items_view,name="non_returnable_items_view"),
    path("item_js", views.item_js, name="item_js"),
    path("item_available_js", views.item_available_js, name="item_available_js"),
    path("leave_approve_disappove/<pk>",views.leave_approve_disappove,name="leave_approve_disappove"),
    ...
    path("addexamlist_delete/<pk>", views.addexamlist_delete, name="addexamlist_delete"),
    path("assign_view_student/<pk>",views.assign_view_student,name="assign_view_student"),
    path("addexamsubject/<pk>", views.addexamsubject, name="addexamsubject"),
    path("delete_exam_subjects/<pk>",views.delete_exam_subjects,name="delete_exam_subjects"),
    ...
    path("Staff_details_show/<pk>", views.Staff_details_show, name="Staff_details_show"),
    path("staff_disable_enable", views.staff_disable_enable, name="staff_disable_enable"),
    path("add_staffs_edit/<pk>", views.add_staffs_edit, name="add_staffs_edit"),
    path("staff_attendance_view",views.staff_attendance_view,name="staff_attendance_view"),
    ...
    path("Mange_alumini_edit/<pk>", views.Mange_alumini_edit, name="Mange_alumini_edit"),
    path("Mange_alumini_delete/<pk>",views.Mange_alumini_delete,name="Mange_alumini_delete"),
    path("mange_alumini_report", views.mange_alumini_report, name="mange_alumini_report"),
    ...
    path("book_inventory_report",views.book_inventory_report,name="book_inventory_report"),
    path("book_due_report", views.book_due_report, name="book_due_report"),
    path("book_issue_return_report",views.book_issue_return_report,name="book_issue_return_report"),
    ...
    path("student_attendance_type_report",views.student_attendance_type_report,name="student_attendance_type_report"),
    ...
    path("manage_syllabus_status",views.manage_syllabus_status,name="manage_syllabus_status"),
    ...
    path("add_homework_delete/<pk>",views.add_homework_delete,name="add_homework_delete"),
    # website part
    ...
    path("infrastructure_edit<pk>", views.infrastructure_edit, name="infrastructure_edit"),
    path("infrastructure_delete<pk>",views.infrastructure_delete,name="infrastructure_delete"),
    ...
    path("school_staff_delete<pk>", views.school_staff_delete, name="school_staff_delete"),
    ...
    path("teacher_rating_approval/<pk>",views.teacher_rating_approval,name="teacher_rating_approval"),
    path("teacher_rating_delete/<pk>",views.teacher_rating_delete,name="teacher_rating_delete"),
    path("admission_report", views.admission_report, name="admission_report"),
    path("balances_fees_report", views.balances_fees_report, name="balances_fees_report"),
    path("class_subject_report", views.class_subject_report, name="class_subject_report"),
    path("examinations_report", views.examinations_report, name="examinations_report"),
    path("expense_group_report", views.expense_group_report, name="expense_group_report"),
    path("expense_report", views.expense_report, name="expense_report"),
    path("fees_collection_report",views.fees_collection_report,name="fees_collection_report"),
    path("Finances_report", views.Finances_report, name="Finances_report"),
    path("homework_evaluation_report",views.homework_evaluation_report,name="homework_evaluation_report"),
    ...
    path("Report_payroll_report",views.Report_payroll_report,name="Report_payroll_report"),
    path("sibling_report", views.sibling_report, name="sibling_report"),
    path("student_gender_ratio_report",views.student_gender_ratio_report,name="student_gender_ratio_report"),
    path("student_teacher_ratio_report",views.student_teacher_ratio_report,name="student_teacher_ratio_report"),
    path("student_profile_report",views.student_profile_report,name="student_profile_report"),
    path("send_email", views.send_email, name="send_email"),
    path("get_sections/", views.get_sections, name="get_sections"),
    path("manage_lesson_topic_js",views.manage_lesson_topic_js,name="manage_lesson_topic_js"),
    path("manage_lesson_save", views.manage_lesson_save, name="manage_lesson_save"),
    path("edit_manage_lesson_js",views.edit_manage_lesson_js,name="edit_manage_lesson_js"),
    path("manage_lesson_delete/<pk>",views.manage_lesson_delete,name="manage_lesson_delete"),
    path("syllabus_status_report",views.syllabus_status_report,name="syllabus_status_report"),
    path("student_report_finances_js",views.student_report_finances_js,name="student_report_finances_js"),
    path("import_student", views.import_student, name="import_student"),
    path("import_staff", views.import_staff, name="import_staff"),
    path("student_login_credentials",views.student_login_credentials,name="student_login_credentials"),
    path("subject_lesson_paln_report",views.subject_lesson_paln_report,name="subject_lesson_paln_report"),
    path("generate_student_certificate",views.generate_student_certificate,name="generate_student_certificate"),
    path("printing_student_certificate",views.printing_student_certificate,name="printing_student_certificate"),
    ...
    path("mail_search_delete_js",views.mail_search_delete_js,name="mail_search_delete_js"),
    ...
    path("staff_meeting_edit/<pk>", views.staff_meeting_edit, name="staff_meeting_edit"),
    path("staff_meeting_delete/<pk>",views.staff_meeting_delete,name="staff_meeting_delete"),
    path("parent_meeting", views.parent_meeting, name="parent_meeting"),
    path("parent_meeting_edit/<pk>",views.parent_meeting_edit,name="parent_meeting_edit"),
    path("parent_meeting_delete/<pk>",views.parent_meeting_delete,name="parent_meeting_delete"),
    path("staff_meetimg_backup/<pk>",views.staff_meetimg_backup,name="staff_meetimg_backup"),
    path("staff_meeting_view/<pk>", views.staff_meeting_view, name="staff_meeting_view"),
    path("student_details_edit/<pk>",views.student_details_edit,name="student_details_edit"),
    path("student_details_delete/<pk>",views.student_details_delete,name="student_details_delete"),
    path("stu_libary_surrender_card/<pk>",views.stu_libary_surrender_card,name="stu_libary_surrender_card"),
    ...
    path("event_calendar_delete",views.event_calendar_delete,name="event_calendar_delete"),
    path("calendarnofication_edit/<pk>",views.calendarnofication_edit,name="calendarnofication_edit"),
    path("calendarnofication_delete/<pk>",views.calendarnofication_delete,name="calendarnofication_delete"),
    ...
    path("custom_fields_edit/<pk>", views.custom_fields_edit, name="custom_fields_edit"),
    path("custom_fields_delete/<pk>",views.custom_fields_delete,name="custom_fields_delete"),
    ...
    path("system_fields_student",views.system_fields_student,name="system_fields_student"),
    path("system_fields_staff", views.system_fields_staff, name="system_fields_staff"),
    path("student_doc_delete/<pk>", views.student_doc_delete, name="student_doc_delete"),
    path("delete_staff_document/<pk>",views.delete_staff_document,name="delete_staff_document"),
    path("delete_staff_timeline/<pk>",views.delete_staff_timeline,name="delete_staff_timeline"),
    ...
    path("fees_carry_forward_save",views.fees_carry_forward_save,name="fees_carry_forward_save"),
    
    path("fees_carry_forward_all",views.fees_carry_forward_all,name="fees_carry_forward_all"),
    
    path("guardian_master", views.guardian_master, name="guardian_master"),
    path("guardian_master_edit/<pk>", views.guardian_master_edit, name="guardian_master_edit"),
    path("guardian_master_view/<pk>", views.guardian_master_view, name="guardian_master_view"),
    path("guardian_master_delete/<pk>", views.guardian_master_delete, name="guardian_master_delete"),
    
    # path('guardian_save_js', views.guardian_save_js,name='guardian_save_js'),
    # path('guardian_delete_js', views.guardian_delete_js,name='guardian_delete_js'),

    path("meeting_link_master", views.meeting_link_master, name="meeting_link_master"),
    path("meeting_link_master_view/<pk>", views.meeting_link_master_view, name="meeting_link_master_view"),
    path("meeting_link_master_delete/<pk>", views.meeting_link_master_delete, name="meeting_link_master_delete"),
    path("meeting_link_master_edit/<pk>", views.meeting_link_master_edit, name="meeting_link_master_edit"),
    
    path("online_class_attendance/<pk>", views.online_class_attendance, name="oline_class_attendance"),
    
    path("guardian_delete/<pk>", views.guardian_delete, name="guardian_delete"),

    path("school_registration", views.school_registration, name="school_registration"),
    path("school_registration_edit/<pk>", views.school_registration_edit, name="school_registration_edit"),
    path("school_registration_view/<pk>", views.school_registration_view, name="school_registration_view"),

    path("school_registration_delete/<pk>", views.school_registration_delete, name="school_registration_delete"),
    path("select_school", views.select_school, name="select_school"),
    path("create_school_registration",views.create_school_registration,name="create_school_registration"),
    path("create_branch/<pk>",views.create_branch,name="create_branch"),
    path("select_branch/<str:pk>",views.select_branch,name="select_branch"),

    path("create_branch_school",views.create_branch_school,name="create_branch_school"),
...
#=====================20/08=====================
    ...
    path('create_question_paper', views.create_question_paper, name='create_question_paper'),
    path('add_questions/<int:paper_id>/', views.add_questions, name='add_questions'),
    path('questions/<int:paper_id>/', views.question_list, name='question_list'),
    
    path("enrollment",views.enrollment,name="enrollment"),
    path("question_paper_delete/<pk>",views.question_paper_delete,name="question_paper_delete"),
    path("enrollment_assign/<pk>",views.enrollment_assign,name="enrollment_assign"),
    
    path("enrollment_assign_delete/<question_paper_id>/<data_id>",views.enrollment_assign_delete,name="enrollment_assign_delete"),
    path("enrollment_assign_view/<question_paper_id>/<data_id>",views.enrollment_assign_view,name="enrollment_assign_view"),
    path("enrollment_assign_edit/<question_paper_id>/<data_id>",views.enrollment_assign_edit,name="enrollment_assign_edit"),
    path("question_paper_sent",views.question_paper_sent,name="question_paper_sent"),
    path("online_exam_assign/<pk>",views.online_exam_assign,name="online_exam_assign"),
    path("answer_paper_correction",views.answer_paper_correction,name="answer_paper_correction"),
    
    path("curreny", views.curreny, name="curreny"),
    path("curreny_view/<pk>", views.curreny_view, name="curreny_view"),
    path("curreny_delete/<pk>", views.curreny_delete, name="curreny_delete"),
    path("curreny_edit/<pk>", views.curreny_edit, name="curreny_edit"),
    
    path("add_curreny", views.add_curreny, name="add_curreny"),
    
    path("accouting_report",views.accouting_report,name="accouting_report"),
    
    path("accouting_details_report",views.accouting_details_report,name="accouting_details_report"),
    
    path("accouting_more_details/<transaction_id>",views.accouting_more_details,name="accouting_more_details"),

    path("accouting_ledger",views.accouting_ledger,name="accouting_ledger"),    

    path("statement_cashflow",views.statement_cashflow,name="statement_cashflow"),
    
    path("account_transaction",views.statement_payment,name="account_transaction"),
    
    path("statement_receipt",views.statement_receipt,name="statement_receipt"),
    
    path("trail_balance_report",views.trail_balance_report,name="trail_balance_report"),
    
    path("payable_listing",views.payable_listing,name="payable_listing"),
    path("receivable_listing",views.receivable_listing,name="receivable_listing"),
    
    path("statement_changes_in_equity",views.statement_changes_in_equity,name="statement_changes_in_equity"),
    path("statement_financial_position",views.statement_financial_position,name="statement_financial_position"),
    
    path("budget_forecast",views.budget_forecast,name="budget_forecast"),
    
    
    path("expense_category", views.expense_category, name="expense_category"),
    path("expense_category_edit/<pk>", views.expense_category_edit, name="expense_category_edit"),
    path("expense_category_view/<pk>", views.expense_category_view, name="expense_category_view"),
    path("expense_category_delete/<pk>", views.expense_category_delete, name="expense_category_delete"),
    
    
    path("create_expense", views.create_expense, name="create_expense"),    
    path("create_expense_edit/<pk>", views.create_expense_edit, name="create_expense_edit"),
    path("create_expense_view/<pk>", views.create_expense_view, name="create_expense_view"),
    path("create_expense_delete/<pk>", views.create_expense_delete, name="create_expense_delete"),
    
    path("invoice_granate", views.invoice_granate, name="invoice_granate"),
    
    path("previous_invoice", views.previous_invoice, name="previous_invoice"),
    ...
    path("view_invoice/<pk>", views.view_invoice, name="view_invoice"),
    
    
    path("vendor", views.vendor, name="vendor"),
    path("vendor_edit/<pk>", views.vendor_edit, name="vendor_edit"),
    path("vendor_view/<pk>", views.vendor_view, name="vendor_view"),
    path("vendor_delete/<pk>", views.vendor_delete, name="vendor_delete"),
...
# ==============================Start Alumni===========================
    ...
    path('alumni_type/view/<int:pk>/', views.view_alumni_type, name='view_alumni_type'),
    ...
    # path('alumni/view/<int:pk>/', views.alumni_view, name='alumni_view'),
    ...
    path('event/view/<int:pk>/', views.view_event, name='view_event'),
    ...
    path("warning_page/", views.warning_page, name="warning_page"),
    
    path("exam_type", views.exam_type_list, name="exam_type_list"),
    
    path("exam_type_edit/<pk>", views.exam_type_edit, name="exam_type_edit"),
    path("exam_type_view/<pk>", views.exam_type_view, name="exam_type_view"),
    path("exam_type_delete/<pk>", views.exam_type_delete, name="exam_type_delete"),
    

    path("import_data_excel", views.import_data_excel, name="import_data_excel"),

    path("import_gl_lines", views.import_gl_lines, name="import_gl_lines"),

    path("import_asset_types", views.import_asset_types, name="import_asset_types"),

    path("import_accounts", views.import_accounts, name="import_accounts"),

    path("import_transaction_codes", views.import_transaction_codes, name="import_transaction_codes"),

    path("import_transaction_types", views.import_transaction_types, name="import_transaction_types"),

    # path("parent_api_call",views.parent_api_call, name="parent_api_call"),
...
#==========================  view1 ==========================
    ...
    path("feedback_list", views1.feedback_list, name="feedback_list"),
    path("feedback_create", views1.feedback_create, name="feedback_create"),
