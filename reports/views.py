...
def general_ledger_with_diff_sub_ledgers(request):
    try:
        if request.method == 'GET':
            user_details = request.user
            company_id = None if user_details.company_name is None else user_details.company_name.pk
            ...
            template_name = 'reports/general_ledger_with_diff_sub_ledgers.html'
            return render(request, template_name, context)
...
def receivable_listing(request):
    if request.method == 'GET':
        user_details = request.user
        obj = AccountReceivable.objects.filter(company_name=request.user.company_name)
        context = {
            'obj':obj,
            'screen_name':'Receivable Listing'
        }
        template_name = 'reports/receivable_listing.html'
        return render(request, template_name, context)
...
def account_payable_listing(request):
    if request.method == 'GET':
        ...
        template_name = 'reports/account_payable_listing.html'
        return render(request, template_name, context)
...
def statement_of_cash_flow(request):
    if request.method == 'GET':
        ...
        template_name = 'reports/statement_of_cash_flow.html'
        return render(request, template_name, context)
...
def statement_of_receipt(request):
    if request.method == 'GET':
        ...
        print('context ',context)
        template_name = 'reports/statement_of_receipt.html'
        return render(request, template_name, context)
...
def statement_of_payment(request):
    if request.method == 'GET':
        ...
        template_name = 'reports/statement_of_payment.html'
        return render(request, template_name, context)
